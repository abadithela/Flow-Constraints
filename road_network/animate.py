...
car_figure = main_dir + '/imglib/red_car.png'
...
def draw_car(pac_data, theta_d, merge = False):
    ...
    offset = 0.1
    ax.imshow(car_fig, zorder=1, interpolation='bilinear', extent=[z+5, z+TILESIZE-5, x+5, x+TILESIZE-5])
