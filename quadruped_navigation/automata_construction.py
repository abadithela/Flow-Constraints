...
def get_tester_BA(): # from tester spec
    '''
...
def get_system_BA(): # from system spec
    '''
...
def create_ts_automata_and_virtual_game_graph(network):
    ...
    # add the transitions that the tulip synchronous product function disregarded
    virtual.states.add_from([('s5', ('T0_S2_test', 'T0_init_sys'))])
    virtual.states.add(('s6', ('T0_S2_test', 'accept_all_sys')))
    virtual.states.accepting.add(('s6', ('T0_S2_test', 'accept_all_sys')))
    virtual.transitions.add(('s3', ('T0_S2_test', 'T0_init_sys')), ('s5', ('T0_S2_test', 'T0_init_sys')), letter={'(door2)'})
    virtual.transitions.add(('s5', ('T0_S2_test', 'T0_init_sys')), ('s6', ('T0_S2_test', 'accept_all_sys')), letter={'(goal)'})
    virtual.transitions.add(('s5', ('T0_S2_test', 'T0_init_sys')), ('s4', ('accept_all_test', 'T0_init_sys')), letter={'(door1)'})
    virtual.states.add_from([('s4', ('T1_S3_test', 'T0_init_sys'))])
    virtual.states.add(('s6', ('T1_S3_test', 'accept_all_sys')))
    virtual.states.accepting.add(('s6', ('T1_S3_test', 'accept_all_sys')))
    virtual.transitions.add(('s3', ('T1_S3_test', 'T0_init_sys')), ('s4', ('T1_S3_test', 'T0_init_sys')), letter={'(door1)'})
    virtual.transitions.add(('s4', ('T1_S3_test', 'T0_init_sys')), ('s5', ('accept_all_test', 'T0_init_sys')), letter={'(door2)'})
    virtual.transitions.add(('s4', ('T1_S3_test', 'T0_init_sys')), ('s6', ('T1_S3_test', 'accept_all_sys')), letter={'(goal)'})
    virtual.transitions.add(('s3', ('accept_all_test', 'T0_init_sys')), ('s5', ('accept_all_test', 'T0_init_sys')), letter={'(door2)'})
    virtual.transitions.add(('s3', ('accept_all_test', 'T0_init_sys')), ('s4', ('accept_all_test', 'T0_init_sys')), letter={'(door1)'})
